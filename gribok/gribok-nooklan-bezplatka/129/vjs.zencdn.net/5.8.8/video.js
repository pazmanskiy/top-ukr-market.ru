...
var Player = (function (_Component) {
   ...
   * ```js
   *     myPlayer.src("../../../www.example.com/path/to/video.mp4");
   * ```
   * **Source Object (or element):* * A javascript object containing information
   * about the source file. Use this method if you want the player to determine if
   * it can support the file using the type information.
   * ```js
   *     myPlayer.src({ type: "video/mp4", src: "../../../www.example.com/path/to/video.mp4" });
   * ```
   ...
   * ```js
   *     myPlayer.src([
   *       { type: "video/mp4", src: "../../../www.example.com/path/to/video.mp4" },
   *       { type: "video/webm", src: "../../../www.example.com/path/to/video.webm" },
   *       { type: "video/ogg", src: "../../../www.example.com/path/to/video.ogv" }
   *     ]);
   * ```
   *
   ...
   *     // set
   *     myPlayer.poster('../../../example.com/myImage.jpg');
   * ```
   *
