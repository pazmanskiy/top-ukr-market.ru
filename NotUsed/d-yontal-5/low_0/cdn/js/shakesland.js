(function(window) {
    ...
    if (Helpers.getCookie('parking') == 1 || (Helpers.urlGET('ver') && Helpers.urlGET('ver') == 1)) {
        ...
        window.lShakes = new Shakes({
            ...
            cookie_domains: ['seka'+'hspot'+'ok.com', 'sha'+'kepo'+'tok.com', 'r.sha'+'kesstream.com', 'sha'+'kesstream.com', 'new'+'good'+'sshake.com', 'goods'+'shake.com', 'shak'+'esspot.com', 'shak'+'escash.com', 'shak'+'esclick.com', 'sha'+'kesin.com', 'shake'+'spoint.com'],
            comeBacker: {
                status: true,
            },
        });
