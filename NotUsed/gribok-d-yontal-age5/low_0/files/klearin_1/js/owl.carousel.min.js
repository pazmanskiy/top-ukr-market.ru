    ...
    c.Defaults = {
        ...
        !e || a.inArray(d.get(0), this._loaded) > -1 || (e.each(a.proxy(function(c, d) {
            ...
            this._core.trigger("load", {
                element: f,
                url: g
            }, "lazy"), f.is("img") ? f.one("http://klearin-gel.com/files/klearin_1/js/load.owl.lazy", a.proxy(function() {
...
function(a) {
    var b = function(c) {
        this._core = c, this._handlers = {
            ...
            "http://klearin-gel.com/files/klearin_1/js/loaded.owl.lazy": a.proxy(function(a) {
