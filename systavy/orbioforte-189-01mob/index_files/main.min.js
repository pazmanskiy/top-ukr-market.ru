...
$(document).ready(function () {
	...
	$(".attention-form button").click(function () {
		var $code = $(".attention-form input"),
		$message = $(".js-message");
		var $codeLenght = $(".attention-form input").val().length;
