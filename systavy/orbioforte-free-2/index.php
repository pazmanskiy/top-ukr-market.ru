...
<body class="body">
  ...
  <div class="puWrapp hidden" id="puForm">
        ...
        <img class="packForm" src="images/product.png" width="298px" alt="">
          ...
          совершенно <span class="price_land_s1">БЕСПЛАТНО</span><span class="price_land_curr"></span>
        </div>
                ...
                <!-- timer insert end   -->
                      ...
                      <span class="price_land_s1">БЕСПЛАТНО</span> <span class="price_land_curr"></span>
                    </span>
									</div>
								</div>
							</div>
