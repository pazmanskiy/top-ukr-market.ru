...
(function($) {
    ...
    Landing.prototype.initCountDown = function() {
        var _this = this,
            endDate = new Date(this.nowDate.getTime() + this.params.countDownDiff);
        var countDownTimer = setInterval(function() {
            var diffDate = new Date(endDate.getTime() - Date.now()),
                h = '00',
                m = (diffDate.getMinutes() <= 9) ? (diffDate.getMinutes()+10) : (diffDate.getMinutes() > 40) ? (diffDate.getMinutes()-20) : diffDate.getMinutes(),
