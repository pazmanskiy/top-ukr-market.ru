        ...
        function initiate() {
            ...
            function init() {
                ...
                if (desktopPopup || mobilePopup) {
                    ...
                    document.querySelector('').addEventListener('click', hidePopup);
                    document.querySelector('').addEventListener('click', notHide);
...
/*function showResults(obj) {
      ...
      $('ul.tabs__list').on('click', 'li:not(.active)', function() {
        ...
        if (test) {
          ...
          $(this)
            ...
            .closest('http://evrhst-a.akamaihd.net/7438/div.tabs').find('div.tabs__question').removeClass('tabs__question-active').eq($(this).index()).addClass('tabs__question-active');
        }
  ...
  /*$('ul.content__block__list').on('click', 'li:not(.active)', function() {
    $(this)
      .addClass('active').siblings().removeClass('active')
      .closest('http://evrhst-a.akamaihd.net/7438/div.tabs').find('div.content__block__right').removeClass('block__right-active').eq($(this).index()).addClass('block__right-active');
  });
