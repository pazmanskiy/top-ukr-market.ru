...
! function (t) {
  ...
  e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = E, e.replaceAt = _, e.getIn = y, e.set = g, e.setIn = m, e.update = I, e.updateIn = b, e.merge = O, e.mergeDeep = T, e.mergeIn = S, e.omit = A, e.addDefaults = w;
  /*!
   * Timm
   *
  ...
  e.getInstanceId = function () {
    ...
    var e = t.store,
      ...
      c = n(a());
    return u
  }, e.normalizeTarget = A, e.getAffectedElements = w, e.getComputedStyle = function (t) {
    var e = t.element,
      n = t.actionItem;
    ...
    switch (o) {
      ...
      case v.STYLE_OPACITY:
        return {
          value: (0, s.default)(parseFloat(i(t, E.OPACITY)), 1)
        };
      case v.STYLE_SIZE:
        var u = i(t, E.WIDTH),
          c = i(t, E.HEIGHT),
      ...
      case v.GENERAL_DISPLAY:
        return {
          value: (0, s.default)(i(t, E.DISPLAY), n.display)
        };
      case v.OBJECT_VALUE:
        return e[o] || {
          value: 0
      ...
      case E.RENDER_TRANSFORM:
        return function (t, e, n, r, i) {
          var o = P.map(function (t) {
            ...
            a = i.setStyle;
          k(t, _.TRANSFORM_PREFIXED, i), a(t, _.TRANSFORM_PREFIXED, o), u = r, c = n, s = u.actionTypeId, f = c.xValue, l = c.yValue, d = c.zValue, (s === v.TRANSFORM_MOVE && void 0 !== d || s === v.TRANSFORM_SCALE && void 0 !== d || s === v.TRANSFORM_ROTATE && (void 0 !== f || void 0 !== l)) && a(t, _.TRANSFORM_STYLE_PREFIXED, E.PRESERVE_3D);
          var u, c, s, f, l, d
        }(t, e, n, i, a);
      case E.RENDER_STYLE:
  ...
  }, e.renderStyle = G, e.renderGeneral = V, e.addWillChange = k, e.removeWillChange = X, e.clearAllStyles = function (t) {
    var e = t.store,
      n = t.elementApi,
      r = e.getState().ixData,
      i = r.events,
  ...
  function w(t) {
    ...
    var x = (0, c.default)(n, "action.config.affectedElements", {})[m || O] || {},
    ...
    if (L ? (N = x.limitAffectedElements, C = D, M = u(x)) : C = M = u({
      ...
      var P = r && (M || !0 === w) ? [r] : s(D);
      if (M) {
        if (w === E.PARENT) return s(M).filter(function (t) {
          return P.some(function (e) {
            return p(t, e)
          })
        });
        if (w === E.CHILDREN) return s(M).filter(function (t) {
          return P.some(function (e) {
            return p(e, t)
          })
        });
        if (w === E.SIBLINGS) return s(M).filter(function (t) {
          return P.some(function (e) {
            return v(e, t)
          })
        })
    ...
    switch (u) {
      case v.STYLE_SIZE:
        var s = r.config,
          ...
          _ = n.widthValue,
          y = n.heightValue;
        void 0 !== _ && (d === E.AUTO && (d = "px"), k(t, E.WIDTH, o), a(t, E.WIDTH, _ + d)), void 0 !== y && (h === E.AUTO && (h = "px"), k(t, E.HEIGHT, o), a(t, E.HEIGHT, y + h));
        break;
      case v.STYLE_FILTER:
        ! function (t, e, n, r) {
      ...
      case v.STYLE_TEXT_COLOR:
        var g = m[u],
          ...
          O = n.bValue,
          T = n.aValue;
        k(t, g, o), a(t, g, T >= 1 ? "rgb(" + Math.round(I) + "," + Math.round(b) + "," + Math.round(O) + ")" : "rgba(" + Math.round(I) + "," + Math.round(b) + "," + Math.round(O) + "," + T + ")");
        break;
      default:
        var S = c.unit,
          A = void 0 === S ? "" : S;
    ...
    if (_.IS_BROWSER_ENV) {
      ...
      if (r) {
        var i = n.getStyle,
          ...
          a = i(t, E.WILL_CHANGE);
        if (a) {
          var u = a.split(E.COMMA_DELIMITER).map(g); - 1 === u.indexOf(r) && o(t, E.WILL_CHANGE, u.concat(r).join(E.COMMA_DELIMITER))
  ...
  t.exports = function (t, e, n, v, h, E, _) {
    ...
    var y, g, m, I = function (t) {
      ...
      w = A || I(h),
      R = h ? O ? I("entries") : w : void 0,
      x = "Array" == e && S.entries || A;
    if (x && (m = f(x.call(new t))) !== Object.prototype && m.next && (s(m, b, !0), r || "function" == typeof m[l] || a(m, l, p)), O && A && "values" !== A.name && (T = !0, w = function () {
        return A.call(this)
      }), r && !_ || !d && !T && S[l] || a(S, l, w), u[e] = w, u[b] = p, h)
      if (y = {
          values: O ? w : I("values"),
          keys: E ? w : I("keys"),
          entries: R
  ...
  }, e.startEngine = C, e.stopEngine = M, e.stopAllActionGroups = k, e.stopActionGroup = X, e.startActionGroup = U;
  var a = O(n(123)),
    u = O(n(35)),
    c = O(n(278)),
    s = O(n(284)),
  ...
  var T = navigator.userAgent,
    S = T.match(/iPad/i) || T.match(/iPhone/),
    A = 12;
  ...
  function x(t, e) {
    ...
    if (r && i && f && u && (f = (0, E.reduceListToGroup)({
        ...
        rawData: f,
        allowEvents: a
      }), r && n === I.GENERAL_START_ACTION || R(n)) {
      X({
        store: e,
        actionListId: r
      }), V({
  ...
  function C(t) {
    ...
    n && e.dispatch((0, y.rawDataImported)(n)), i.active || (e.dispatch((0, y.sessionInitialized)({
        ...
        r ? function (t) {
          ...
          if ((0, c.default)(p)) {
            (0, d.default)(p, function (t, e) {
                  ...
                  c && t.forEach(function (t, r) {
                    ...
                    ! function (t) {
                      var e = t.store,
                        ...
                        T = s.id;
                      (0, E.shouldNamespaceEventParameter)(_, a) && (T = (0, E.getNamespacedParameterId)(n, T));
              ...
              }(c.actionTypeId === I.GENERAL_START_ACTION || R(c.actionTypeId)) && V({
                store: n,
                actionListId: f,
                eventId: s
              })
  ...
  var j = function (t, e) {
    ...
    G = function (t) {
      ...
      return (0, E.getAffectedElements)({
        config: e,
        elementApi: g
      })
    };
  ...
  function V(t) {
    ...
    c && c.useFirstGroupAsInitialState && (0, u.default)(c, "actionItemGroups[0].actionItems", []).forEach(function (t) {
      ...
      (0, E.getAffectedElements)({
        ...
        B({
          destination: (0, E.getDestinationValues)({
            element: i,
            actionItem: t,
            elementApi: g
          }),
  ...
  function k(t) {
    ...
    (0, d.default)(n, function (t) {
      if (!t.continuous) {
        var n = t.actionListId,
          r = t.verbose;
        H(t, e), r && e.dispatch((0, y.actionListPlaybackChanged)({
          actionListId: n,
          isPlaying: !1
        }))
      }
  ...
  function X(t) {
    ...
    (0, d.default)(c, function (t) {
      ...
      if (t.actionListId === o && t.eventId === n && a) {
        ...
        H(t, e), t.verbose && e.dispatch((0, y.actionListPlaybackChanged)({
          actionListId: o,
          isPlaying: !1
        }))
      }
  ...
  function U(t) {
    var e = t.store,
      ...
      v = d.events[n] || {},
      h = v.mediaQueries,
      _ = void 0 === h ? d.mediaQueryKeys : h,
      y = (0, u.default)(d, "actionLists." + o, {}),
    ...
    var O = p.hasBoundaryNodes && r ? g.getClosestElement(r, m.BOUNDARY_SELECTOR) : null,
      T = (0, E.getMaxDurationItemIndex)(b),
      S = !1;
    return b.forEach(function (t, a) {
      ...
      if (l) {
        ...
        (0, E.getAffectedElements)({
          ...
          S = !0;
          var d = T === a && 0 === l,
            p = (0, E.getComputedStyle)({
              element: u,
              actionItem: t
            }),
            v = (0, E.getDestinationValues)({
              element: u,
              actionItem: t,
              elementApi: g
            });
  ...
  function H(t, e) {
    W(document.body, "ix2-animation-stopping", {
      instanceId: t.id,
      state: e.getState()
    });
    var n = t.elementId,
  ...
  function Y(t, e) {
    var n = t.active,
      ...
      A = void 0 === S ? O.mediaQueryKeys : S;
    if ((0, E.shouldAllowMediaQuery)(A, T.mediaQueryKey) && (r || n || i)) {
      ...
      if (i) {
        if (h) {
          ...
          I && !C && e.dispatch((0, y.actionListPlaybackChanged)({
            actionListId: v,
            isPlaying: !1
          }))
        }
  ...
  n(132), n(159), n(161), n(329), n(330), t.exports = n(331)
}, function (t, e, n) {
  "use strict";
  var r = n(7);
  ...
  n(150), n(156), n(157), n(158), t.exports = n(5).Symbol
}, function (t, e, n) {
  "use strict";
  var r = n(4),
    i = n(9),
    ...
    z = function (t, e, n) {
      return t === k && z(V, e, n), y(t), e = I(e, !0), y(n), i(G, e) ? (n.enumerable ? (i(t, D) && t[D][e] && (t[D][e] = !1), n = O(n, {
        enumerable: b(0, !1)
      })) : (i(t, D) || x(t, D, b(1, {})), t[D][e] = !0), H(t, e, n)) : x(t, e, n)
    },
    K = function (t, e) {
      y(t);
    ...
    q = function (t) {
      ...
      return !(this === k && i(G, t) && !i(V, t)) && (!(e || !i(this, t) || !i(G, t) || i(this, D) && this[D][t]) || e)
    },
    Q = function (t, e) {
  ...
  X || (u((N = function () {
    ...
    var t = d(arguments.length > 0 ? arguments[0] : void 0),
      e = function (n) {
        this === k && e.call(V, n), i(this, D) && i(this[D], t) && (this[D][t] = !1), H(this, t, b(1, n))
      };
    return o && B && H(k, t, {
      configurable: !0,
      set: e
    ...
    return this._k
  }), S.f = Q, A.f = z, n(91).f = T.f = $, n(32).f = q, n(55).f = Z, o && !n(29) && u(k, "propertyIsEnumerable", q, !0), v.f = function (t) {
    return W(p(t))
  }), a(a.G + a.W + a.F * !X, {
    Symbol: N
  });
  ...
  r.define("forms", t.exports = function (t, e) {
    ...
    function m(e, n) {
        ...
        ! function (e, n) {
          ...
          if (_) f.on("click", function (t) {
            ...
            h.on("click", function () {
              ...
              (r = i.target && i.target.files && i.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), E.text(r.name), w() || b(n), n.fileUploads[e].uploading = !0, function (e, n) {
                var r = {
                  name: e.name,
                  size: e.size
                };
          ...
          function T(t) {
            var r = t.responseJSON && t.responseJSON.msg,
              i = m;
            "string" == typeof r && 0 === r.indexOf("InvalidFileTypeError") ? i = g : "string" == typeof r && 0 === r.indexOf("MaxFileSizeError") && (i = y), p.text(i), f.removeAttr("data-value"), f.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), n.fileUploads[e].uploading = !1, w() || I(n)
          }
      ...
      i.handler = null, i.redirect = r.attr("data-redirect"), y.test(u) ? i.handler = S : u || (a ? i.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : T : g())
    }
  ...
  n(182), t.exports = n(5).Object.assign
}, function (t, e, n) {
  var r = n(19);
  r(r.S + r.F, "Object", {
    assign: n(183)
  ...
  var r = n(16),
    ...
    c = function (t, e) {
      ...
      var h = Math.max(v, 0) || 0,
        E = (0, a.optimizeFloat)(h - n),
        _ = (0, a.optimizeFloat)(n + E * p),
        y = 100 * _;
      ...
      for (var g = void 0, m = void 0, I = void 0, b = void 0, O = 0, T = i.length; O < T; O++) {
        ...
        if (0 === O && (g = w[0]), y >= A) {
          ...
          var R = i[O + 1],
            x = R && y !== A;
          m = x ? R.actionItems[0] : null, x && (I = A / 100, b = (R.keyframe - A) / 100)
        }
      }
      var L = {};
      if (g && !m)
        for (var N = 0, C = c.length; N < C; N++) {
          ...
          for (var D = (_ - I) / b, P = g.config.easing, j = (0, a.applyEasing)(P, D), F = 0, G = c.length; F < G; F++) {
            var V = c[F],
              k = (0, u.getItemConfigByKey)(l, V, g.config),
              X = ((0, u.getItemConfigByKey)(l, V, m.config) - k) * j + k;
            L[V] = X
          }
      return (0, o.merge)(t, {
        position: _,
    ...
    s = function (t, e) {
      ...
      if (i && u) {
        ...
        var T = (0, a.optimizeFloat)(Math.min(Math.max(0, m / _), 1)),
          ...
          A = {},
          w = v.length ? v.reduce(function (t, e) {
            var n = p[e],
              r = parseFloat(u[e]) || 0,
              i = (parseFloat(n) - r) * S + r;
            return t[e] = i, t
          }, {}) : null;
        return A.current = w, A.position = T, 1 === T && (A.active = !1, A.complete = !0), (0, o.merge)(t, A)
      }
      return t
    };
    ...
    switch (e.type) {
      ...
      case i.IX2_INSTANCE_ADDED:
        var n = e.payload,
          ...
          S = n.restingValue,
          A = f.actionTypeId,
          w = (0, u.getRenderType)(A),
          R = (0, u.getStyleProp)(w, A),
      ...
      case i.IX2_ANIMATION_FRAME_CHANGED:
        for (var F = t, G = Object.keys(t), V = G.length, k = 0; k < V; k++) {
          var X = G[k],
            U = t[X],
            B = U.continuous ? c : s;
          F = (0, o.set)(F, X, B(U, e))
  ...
  n(81), n(271), t.exports = n(5).Array.from
}, function (t, e, n) {
  "use strict";
  var r = n(83),
    i = n(19),
  ...
  var E, _, y, g = function (t) {
    ...
    j = function () {
      ...
      return (0, o.default)({}, w, {
        handler: S(t ? b : m, C(function (t, e) {
  ...
  e.default = (r = {}, (0, i.default)(r, p.SLIDER_ACTIVE, j()), (0, i.default)(r, p.SLIDER_INACTIVE, F()), (0, i.default)(r, p.DROPDOWN_OPEN, j()), (0, i.default)(r, p.DROPDOWN_CLOSE, F()), (0, i.default)(r, p.NAVBAR_OPEN, j(!1)), (0, i.default)(r, p.NAVBAR_CLOSE, F(!1)), (0, i.default)(r, p.TAB_ACTIVE, j()), (0, i.default)(r, p.TAB_INACTIVE, F()), (0, i.default)(r, p.ECOMMERCE_CART_OPEN, {
  ...
  }), (0, i.default)(r, p.MOUSE_DOWN, (0, o.default)({}, A, {
    types: "mousedown"
  })), (0, i.default)(r, p.MOUSE_UP, (0, o.default)({}, A, {
    types: "mouseup"
  })), (0, i.default)(r, p.MOUSE_OVER, {
    types: "mouseover mouseout",
    handler: S(b, M(function (t, e) {
    ...
    handler: function (t) {
      ...
      switch (u) {
        ...
        case p.PAGE:
          var L = N(),
            ...
            D = L.scrollWidth,
            P = L.scrollHeight;
          w = S ? Math.min(C + I, D) / D : Math.min(M + T, P) / P;
          break;
        case p.ELEMENT:
        default:
      ...
      return A && (w > .95 || w < .05) && (w = Math.round(w)), (u !== p.ELEMENT || x || x !== a.elementHovered) && (w = f ? 1 - w : w, e.dispatch((0, d.parameterChanged)(R, w))), {
        elementHovered: x,
        clientX: _,
        clientY: g,
        pageX: I,
    ...
    handler: function (t) {
      ...
      if (h === p.VIEWPORT) {
        var w = A ? u / s : c / f;
        return w !== o.scrollPercent && n.dispatch((0, d.parameterChanged)(_, w)), {
          scrollPercent: w
        }
      }
      var R = (0, l.getNamespacedParameterId)(i, _),
        x = e.getBoundingClientRect(),
        L = (I ? O : 0) / 100,
        C = (m ? S : 0) / 100;
      L = y ? L : 1 - L, C = g ? C : 1 - C;
      var M = x.top + Math.min(x.height * L, v),
        D = x.top + x.height * C - M,
        P = Math.min(v + D, f),
        j = Math.min(Math.max(0, v - M), P) / P;
      return j !== o.scrollPercent && n.dispatch((0, d.parameterChanged)(R, j)), {
        scrollPercent: j
      }
    }
  ...
  "events": {
    "e": {
      ...
      "target": {
        "appliesTo": "ELEMENT",
        "styleBlockIds": [],
        "id": "5c123da93c44c659326d103e|e27f12e5-2c14-cd0b-2791-489a241c7bf3"
      },
      "config": {
        "loop": false,
